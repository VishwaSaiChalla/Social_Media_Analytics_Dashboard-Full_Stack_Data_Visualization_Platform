...
class DataTransformer:
    ...
    def perform_basic_transformations(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            if "post_time" in transformed_df.columns:
                transformed_df = self.convert_post_time_to_date_time(
            ...
            if all(
                col in transformed_df.columns for col in ["likes", "comments", "shares"]
            ):
            ...
            if "total_engagement" in transformed_df.columns:
                try:
                    ...
                    engagement_quartiles = transformed_df["total_engagement"].quantile(
                        [0.25, 0.5, 0.75]
                    )
                    ...
                    if not engagement_quartiles.isna().any():
                        transformed_df["engagement_level"] = pd.cut(
                            ...
                            bins=[
                                0,
                                engagement_quartiles[0.25],
                                engagement_quartiles[0.5],
                                engagement_quartiles[0.75],
                                transformed_df["total_engagement"].max(),
                            ],
    ...
    def convert_post_time_to_date_time(
        ...
        try:
            ...
            if transformed_df[post_time_column].dtype == "object":
                ...
                try:
                    ...
                    try:
                        ...
                        transformed_df[temp_datetime_col] = pd.to_datetime(
                            transformed_df[post_time_column], errors="coerce"
                        )
            ...
            if (
                ...
                transformed_df["Posted_time"] = transformed_df[
                    temp_datetime_col
                ].dt.strftime("%H:%M:%S")
