...
class BackendApp:
    ...
    def _init_data_store(self):
        ...
        try:
            ...
            # Check if database is empty and auto-ingest CSV data if needed
        ...
        try:
            ...
            if current_count == 0:
                ...
                csv_path = os.path.join(
                    os.path.dirname(__file__), "Social_Media_Engagement.csv"
                )
                ...
                if success:
                    ...
                    logger.info(
                        f"Auto-ingestion completed successfully. "
                ...
                logger.info(
                    f"Database already contains {current_count} records. "
                    f"Skipping auto-ingestion."
                )
    ...
    def _setup_routes(self):
                    ...
                    return jsonify(
                        {
                            ...
                            "message": (
                                ...
                                f"{current_count} records. "
                                f"CSV ingestion skipped."
                            ),
            ...
            try:
                ...
                def insert_mock_data():
                    ...
                    try:
                        ...
                        logger.info(
                            f"Scheduler: Generating {num_records} "
                            f"new mock records..."
                        )
                        ...
                        try:
                            df = mock_data_generator(
                                num_records, data_store=self.data_store
                            )
                            logger.info(
                                f"Scheduler: Successfully generated "
                                f"{len(df)} mock records"
                            )
                        except Exception as gen_error:
                            logger.error(
                                f"Scheduler: Failed to generate mock data: "
                                f"{gen_error}"
                            )
                            return
                        ...
                        try:
                            if insert_data_to_mongodb(self.data_store, df):
                                logger.info(
                                    f"Scheduled update: Added "
                                    f"{num_records} new records"
                                )
                            else:
                ...
                return jsonify(
                    {
                        ...
                        "message": (
                            ...
                            "Mock data will be inserted every 30 seconds."
                        ),
                    }
                )
        ...
        def get_platform_engagement():
            ...
            try:
                ...
                return jsonify(
                    {"success": True, "platform_engagement": engagement_data}
                )
        ...
        def get_sentiment_by_platform():
            ...
            try:
                ...
                return jsonify(
                    {"success": True, "sentiment_by_platform": sentiment_data}
                )
        ...
        def get_sentiment_by_post_type():
            ...
            try:
                ...
                return jsonify(
                    {"success": True, "sentiment_by_post_type": sentiment_data}
                )
        ...
        def get_average_comments_by_date_platform():
            ...
            try:
                ...
                logger.error(
                    f"Error getting average comments by date and platform: {e}"
                )
                return jsonify({"error": str(e)}), 500
